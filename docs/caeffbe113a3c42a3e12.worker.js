...
/***/ function(module, exports, __webpack_require__) {
	...
	var _markovClientFactory = __webpack_require__(1);

	var _markovClientFactory2 = _interopRequireDefault(_markovClientFactory);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var markovClient = void 0;
	...
	onmessage = function onmessage(event) {
	  ...
	  switch (type) {
	    case 'init':
	      markovClient = (0, _markovClientFactory2.default)(data.lines, data.options);
	      markovClient.buildCorpus().then(function () {
	        return postMessage({
	          type: 'init'
	        });
	      });
	    ...
	    case 'generateSentences':
	      markovClient.generateSentences(data.count).then(function (sentences) {
	        return postMessage({
	          type: 'sentences',
	          sentences: sentences,
	          reqId: reqId
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _markovStrings = __webpack_require__(2);
	...
	var markovClientFactory = function markovClientFactory(lines, options) {
	  var markov = new _markovStrings2.default(lines, options);
	  var buildCorpusPromise = void 0;
	  var buildCorpus = function buildCorpus() {
	  ...
	  var getString = function getString(x) {
	    return x && x.string;
	  };

	  var generateSentence = function generateSentence() {
	    return buildCorpus().then(function () {
	  ...
	  var generateSentences = function generateSentences(count) {
	    return buildCorpus().then(function () {
	      return (0, _utils.range)(count).map(function () {
	...
	exports.default = markovClientFactory;
...
/***/ function(module, exports, __webpack_require__) {
	...
	const _ = __webpack_require__(3),
	  debug = __webpack_require__(5)('markov-strings');
...
/***/ function(module, exports, __webpack_require__) {
	...
	function load() {
	  ...
	  if (typeof process !== 'undefined' && 'env' in process) {
	    return ({"API_URL":undefined}).DEBUG;
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fileUtils = __webpack_require__(11);
...
/***/ function(module, exports) {
	...
	var flatMap = exports.flatMap = function flatMap(a, f) {
	  var _ref;
...
/***/ function(module, exports) {
	...
	var readFileAsText = exports.readFileAsText = function readFileAsText(file) {
